...
echo "-- Running: vtctldclient ApplySchema --sql-file duo_unsharded_schema_update.sql duo_unsharded\n"
vtctldclient ApplySchema --sql-file duo_unsharded_schema_update.sql duo_unsharded || fail "Failed to apply schema SQL for the duo_unsharded keyspace"

# create the vschema for the duo_unshared keyspace
echo "--- Running: vtctldclient ApplyVSchema --vschema-file vschema_duo_unsharded.json duo"
...
echo "--- Running: vtctldclient ApplySchema --sql-file duo_sharded_schema_update.sql duo\n"
vtctldclient ApplySchema --sql-file duo_sharded_schema_update.sql duo || fail "Failed to apply schema for the duo keyspace"
...
echo "--- Running: vtctldclient ApplyVSchema --vschema-file vschema_duo_sharded.json duo"
vtctldclient ApplyVSchema --vschema-file vschema_duo_sharded.json duo || fail "Failed to apply vschema JSON for the duo keyspace"
